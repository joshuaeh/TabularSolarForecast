...
for loss_func in["mae", "mse"]:
    for response_variable in RESPONSE_ORDER:
        for feature_groups in FEATURE_GROUPS_TESTS:
            ...
            test = [loss_func, response_variable, selected_features]
            tests.append(test)

# for i in indices:
#     test = tests[i]
#     loss_func, response_variable, selected_features = test
#     tt = TabularTest(neptune_run_name="Ablation 1.4",
#             scaler_type="minmax",
#             n_steps_in=13,
#             n_steps_out=12,
